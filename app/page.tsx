    ...
    <footer className="pt-16 pb-12 bg-gradient-to-br from-[#7e57c2] via-[#9575cd] to-[#a88bda] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="pt-8 mt-8 border-t border-white/20 text-center">
          ...
          {/* Added creator credit line */}
          <p className="text-white/40 text-xs mt-2 font-light">
            Designed with 💜 by <a href="https://www.linkedin.com/in/ahmed-zouine/" className="hover:text-white/60 transition-colors duration-300 underline-offset-2 hover:underline" target="_blank" rel="noopener noreferrer">Goodman</a>
          </p>
        </div>
      </div>
    </footer>
