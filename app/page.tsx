...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-background">
      ...
      {/* Mobile-optimized Why SyncUp Section - Updated with Yasmine's feedback */}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 mb-8 sm:mb-12">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-card-foreground text-balance">
                impact-driven design—every feature built with real user needs in mind
              </p>
            </div>
          </div>
        ...
        <div className="bg-card dark:bg-card/80 backdrop-blur-sm border border-border rounded-xl p-4 sm:p-6 text-center max-w-4xl mx-auto">
          ...
          <div className="mb-6">
            <Button 
              variant="default" 
              size="lg"
              className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-8 py-3 text-sm sm:text-base"
            >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-3 justify-items-center">
            {/* Twitter */}
            <Button 
              variant="outline" 
              size="sm" 
              className="bg-[#1DA1F2] hover:bg-[#1DA1F2]/90 text-white border-[#1DA1F2] text-xs h-10 w-full"
            ...
            <Button 
              variant="outline" 
              size="sm"
              className="bg-[#1877F2] hover:bg-[#1877F2]/90 text-white border-[#1877F2] text-xs h-10 w-full"
            ...
            <Button 
              variant="outline" 
              size="sm"
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white border-0 text-xs h-10 w-full"
              onClick={() => window.open('https://www.instagram.com/_crescenta.com_/', '_blank')}
            >
              <svg className="w-3 h-3 mr-1 sm:mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Button 
              variant="outline" 
              size="sm"
              className="bg-[#000000] hover:bg-[#000000]/90 text-white border-[#000000] text-xs h-10 w-full"
              onClick={() => window.open(`https://www.tiktok.com/@syncup.com`, '_blank')}
            >
              <svg className="w-3 h-3 mr-1 sm:mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Button 
              ...
              size="sm"
              disabled={isSharing}
              className="text-xs h-10 w-full col-span-2 sm:col-span-1"
              onClick={async () => {
                if (isSharing) return;
