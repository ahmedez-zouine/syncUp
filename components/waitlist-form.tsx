...
export function WaitlistForm() {
			...
			<Card className="w-full max-w-md mx-auto bg-gradient-to-br from-primary/5 to-secondary/5 border-primary/20">
				<CardContent className="p-8 text-center">
					...
					<p className="text-muted-foreground text-balance">
						Thank you for joining our waitlist. We'll notify you as soon as Mimaura
						is ready to support your health journey.
					</p>
				</CardContent>
			</Card>
		)
	...
	return (
		<Card className="w-full max-w-md mx-auto bg-white/80 dark:bg-white/10 backdrop-blur-sm border-[#bcddb0]/40">
			<CardContent className="p-6">
				<form onSubmit={handleSubmit} className="space-y-6">
					<div className="space-y-4">
						<div>
							...
							<Input
								...
								required
								className="mt-1 border-[#bcddb0]/40 focus:border-[#bcddb0] focus:ring-[#bcddb0]"
					...
					<Button
						type="submit"
						disabled={isLoading}
						className="w-full bg-[#bcddb0] hover:bg-[#a9d190] text-[#5a7849] font-medium py-3 transition-colors"
					>
						{isLoading ? (
							<>
